...
<div class="avatar resizer">
  <img id="avatarFile" src="img.jpg" alt="">
  <div class="frames"></div>
</div>
<button class="btn btn_primary" id="useImage">确认使用</button>
*/
  var tmp=$('<div class="resizer avatar have-img">'+
          '<div class="inner">'+
          '<img src="img.jpg">'+
          '<div class="frames"></div>'+
          '</div>'+
  ...
  $.imageResizer=function(){
      ...
      resizer.frames=resizer.find('img');
      resizer.dragObj=resizer.find('img');
      resizer.okButton=resizer.find('button.btn');
